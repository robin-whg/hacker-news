...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ItemViewCommentList: typeof import('./components/ItemView/CommentList.vue')['default']
    ItemViewCommentListItem: typeof import('./components/ItemView/CommentListItem.vue')['default']
