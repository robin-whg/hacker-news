<template>
  ...
  >
    ...
    >
      <i-heroicons-outline-home class="h-7 w-7" />
      Top
    </router-link>
    <router-link
      :to="{ name: 'new' }"
      ...
      active-class="text-primary"
    >
      <i-heroicons-outline-fire class="h-7 w-7" />
      New
    </router-link>
    <router-link
      :to="{ name: 'show' }"
    ...
    <router-link
      ...
      active-class="text-primary"
    >
      <i-heroicons-outline-question-mark-circle class="h-7 w-7" />
      Ask
    </router-link>
    <router-link
      :to="{ name: 'jobs' }"
...
.the-tabbar {
  touch-action: none;
  padding-top: 0.5rem;
  padding-left: calc(0.5rem + env(safe-area-inset-left, 0.5rem));
  padding-right: calc(0.5rem + env(safe-area-inset-left, 0.5rem));
